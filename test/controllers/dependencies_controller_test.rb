...
class DependenciesControllerTest < ActionController::TestCase
  ...
  test "should create dependency" do
    assert_difference('Dependency.count') do
      post :create, dependency: { dependency: @dependency.dependency, description: @dependency.description, masterunit: @dependency.masterunit, name: @dependency.name }
    end
  ...
  test "should update dependency" do
    patch :update, id: @dependency, dependency: { dependency: @dependency.dependency, description: @dependency.description, masterunit: @dependency.masterunit, name: @dependency.name }
    assert_redirected_to dependency_path(assigns(:dependency))
  end
